...
void setup() {
  ...
  mpu.setXAccelOffset(-2280); //Set your accelerometer offset for axis X
  mpu.setYAccelOffset(847); //Set your accelerometer offset for axis Y
  mpu.setZAccelOffset(1577); //Set your accelerometer offset for axis Z
  mpu.setXGyroOffset(117);  //Set your gyro offset for axis X
  mpu.setYGyroOffset(-5);  //Set your gyro offset for axis Y
  mpu.setZGyroOffset(65);  //Set your gyro offset for axis Z
